...
function getBasic(top) {
    ...
    var atomName = db_1.Column.ofStringArray(atomNames);
...
function topologyFromTop(top) {
    ...
    return mol_task_1.Task.create('Parse TOP', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            ...
            basic = getBasic(top);
            bonds = getBonds(top);
            return [2 /*return*/, topology_1.Topology.create(top.system || 'TOP', basic, bonds, format)];
        });
    }); });
}
