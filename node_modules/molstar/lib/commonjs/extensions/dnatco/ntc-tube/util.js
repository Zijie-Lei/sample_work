...
function getPoints(loc, r0, r1, r2, altId0, altId1, altId2, insCode0, insCode1, insCode2) {
    if (r0)
        getAtomPosition(p_1, loc, r0, ['C5\'', 'C5*'], altId0, insCode0);
...
var NtCTubeSegmentsIterator = /** @class */ (function () {
    ...
    NtCTubeSegmentsIterator.prototype.toSegment = function (r0, r1, r2, r3) {
        ...
        return tslib_1.__assign(tslib_1.__assign({}, getPoints(this.loc, r0, r1, r2, altIdPrev, this.altIdOne, altIdTwo, insCodePrev, this.insCodeOne, insCodeTwo)), { stepIdx: stepIdx, followsGap: followsGap, firstInChain: !r0, capEnd: !this.residueNext || precedesDiscontinuity || hasGapElements(r2, this.loc.unit) });
    };
