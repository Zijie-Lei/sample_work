...
var polymer_1 = require("../../../mol-repr/structure/visual/util/polymer");
var util_3 = require("../../../mol-repr/util");
...
var NtCTubeMeshParams = tslib_1.__assign(tslib_1.__assign({}, units_visual_1.UnitsMeshParams), { linearSegments: param_definition_1.ParamDefinition.Numeric(4, { min: 2, max: 8, step: 1 }, base_1.BaseGeometry.CustomQualityParamInfo), radialSegments: param_definition_1.ParamDefinition.Numeric(22, { min: 4, max: 56, step: 2 }, base_1.BaseGeometry.CustomQualityParamInfo), residueMarkerWidth: param_definition_1.ParamDefinition.Numeric(0.05, { min: 0.01, max: 0.25, step: 0.01 }), segmentBoundaryWidth: param_definition_1.ParamDefinition.Numeric(0.05, { min: 0.01, max: 0.25, step: 0.01 }) });
...
var _curvePoint = (0, linear_algebra_1.Vec3)();
var _tanA = (0, linear_algebra_1.Vec3)();
var _tanB = (0, linear_algebra_1.Vec3)();
var _firstTangentVec = (0, linear_algebra_1.Vec3)();
var _lastTangentVec = (0, linear_algebra_1.Vec3)();
var _firstNormalVec = (0, linear_algebra_1.Vec3)();
var _lastNormalVec = (0, linear_algebra_1.Vec3)();
var _tmpNormal = (0, linear_algebra_1.Vec3)();
var _tangentVec = (0, linear_algebra_1.Vec3)();
var _normalVec = (0, linear_algebra_1.Vec3)();
var _binormalVec = (0, linear_algebra_1.Vec3)();
var _prevNormal = (0, linear_algebra_1.Vec3)();
var _nextNormal = (0, linear_algebra_1.Vec3)();
...
function createNtCTubeSegmentsIterator(structureGroup) {
    ...
    var data = (_b = (_a = property_1.NtCTubeProvider.get(structure.model)) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.data;
    if (!data)
    ...
    var getLocation = function (groupId, instanceId) {
        ...
        return types_1.NtCTubeTypes.Location({ step: step, kind: kind });
    };
...
function segmentCount(structure, props) {
    ...
    if (quality === 'custom')
        ...
        var autoQuality = (0, util_3.getStructureQuality)(structure);
...
function stepBoundingSphere(step, struLoci) {
    var one = util_2.DnatcoUtil.residueToLoci(step.auth_asym_id_1, step.auth_seq_id_1, step.label_alt_id_1, step.PDB_ins_code_1, struLoci, 'auth');
    var two = util_2.DnatcoUtil.residueToLoci(step.auth_asym_id_2, step.auth_seq_id_2, step.label_alt_id_2, step.PDB_ins_code_2, struLoci, 'auth');
    if (structure_1.StructureElement.Loci.is(one) && structure_1.StructureElement.Loci.is(two)) {
        var union = (0, structure_set_1.structureUnion)(struLoci.structure, [structure_1.StructureElement.Loci.toStructure(one), structure_1.StructureElement.Loci.toStructure(two)]);
...
function createNtCTubeMesh(ctx, unit, structure, theme, props, mesh) {
    ...
    var prop = property_1.NtCTubeProvider.get(structure.model).value;
    ...
    var mb = mesh_builder_1.MeshBuilder.createState(vertexCount, chunkSize, mesh);
    var state = (0, polymer_1.createCurveSegmentState)(segCount.linear);
    ...
    var markerState = (0, polymer_1.createCurveSegmentState)(MarkerLinearSegmentCount);
    ...
    var firstDir = (0, linear_algebra_1.Vec3)();
    var lastDir = (0, linear_algebra_1.Vec3)();
    var markerDir = (0, linear_algebra_1.Vec3)();
    var residueMarkerWidth = props.residueMarkerWidth / 2;
    var it = new util_1.NtCTubeSegmentsIterator(structure, unit);
    while (it.hasNext) {
        var segment = it.move();
        if (!segment)
            continue;
        ...
        if (segment.followsGap) {
            ...
            mb.currentGroup = FirstBlockId;
            (0, cylinder_1.addFixedCountDashedCylinder)(mb, p_1, p1, 1, 2 * segCount.linear, cylinderProps);
        }
    }
    var boundingSphere = sphere3d_1.Sphere3D.expand((0, sphere3d_1.Sphere3D)(), unit.boundary.sphere, 1.05);
    var m = mesh_builder_1.MeshBuilder.getMesh(mb);
    m.setBoundingSphere(boundingSphere);
    return m;
}
var _rmvCO = (0, linear_algebra_1.Vec3)();
var _rmvPO = (0, linear_algebra_1.Vec3)();
var _rmPos = (0, linear_algebra_1.Vec3)();
var _HalfPi = Math.PI / 2;
function calcResidueMarkerShift(pO, pC, pP) {
    v3sub(_rmvCO, pC, pO);
    v3sub(_rmvPO, pP, pO);
    // Project position of P atom on the O3' -> C5' vector
    var beta = linear_algebra_1.Vec3.angle(_rmvPO, _rmvCO);
    var alpha = _HalfPi - Math.abs(beta);
    var lengthMO = Math.cos(alpha) * linear_algebra_1.Vec3.magnitude(_rmvPO);
    var shift = lengthMO / linear_algebra_1.Vec3.magnitude(_rmvCO);
...
function getNtCTubeSegmentLoci(pickingId, structureGroup, id) {
    ...
    if (!structure_1.Unit.isAtomic(unit))
        return loci_1.EmptyLoci;
    var data = (_c = (_b = (_a = property_1.NtCTubeProvider.get(structure.model)) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.data) !== null && _c !== void 0 ? _c : undefined;
    if (!data)
        return loci_1.EmptyLoci;
    ...
    if (groupId > MeshGroupsCount)
        return loci_1.EmptyLoci;
    var stepIdx = Math.floor(groupId / 4);
    var bs = stepBoundingSphere(data.data.steps[stepIdx], structure_1.Structure.toStructureElementLoci(structure));
    /*
...
var NtCTubeVisuals = {
    'ntc-tube-symbol': function (ctx, getParams) { return (0, representation_2.UnitsRepresentation)('NtC Tube Mesh', ctx, getParams, NtCTubeVisual); },
};
exports.NtCTubeParams = tslib_1.__assign({}, NtCTubeMeshParams);
...
exports.NtCTubeRepresentationProvider = (0, representation_2.StructureRepresentationProvider)({
    ...
    isApplicable: function (structure) { return structure.models.every(function (m) { return property_2.Dnatco.isApplicable(m); }); },
    ensureCustomProperties: {
        attach: function (ctx, structure) { return tslib_1.__awaiter(void 0, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
            return [2 /*return*/, structure.models.forEach(function (m) { return property_1.NtCTubeProvider.attach(ctx, m, void 0, true); })];
        }); }); },
        detach: function (data) { return data.models.forEach(function (m) { return property_1.NtCTubeProvider.ref(m, false); }); },
    },
});
