...
(function (NtCTubeTypes) {
    ...
    function Loci(data, stepIndices, elements, boundingSphere) {
        return (0, loci_1.DataLoci)(DataTag, data, elements, boundingSphere ? function () { return boundingSphere; } : undefined, function () { return stepIndices[0] !== undefined ? (0, behavior_1.NtCTubeSegmentLabel)(data[stepIndices[0]]) : ''; });
    }
    NtCTubeTypes.Loci = Loci;
    function DummyLoci() {
        return (0, loci_1.DataLoci)(DummyTag, {}, [], undefined, function () { return ''; });
    }
...
})(NtCTubeTypes = exports.NtCTubeTypes || (exports.NtCTubeTypes = {}));
