...
var utils_1 = require("./volseg-api/utils");
var entry_meshes_1 = require("./entry-meshes");
var entry_models_1 = require("./entry-models");
var entry_segmentation_1 = require("./entry-segmentation");
...
exports.MAX_VOXELS = Math.pow(10, 7);
...
var SourceChoice = new helpers_1.Choice({ emdb: 'EMDB', empiar: 'EMPIAR', idr: 'IDR' }, 'emdb');
function createLoadVolsegParams(plugin, entrylists) {
    var _a;
    if (entrylists === void 0) { entrylists = {}; }
    var defaultVolumeServer = (_a = plugin === null || plugin === void 0 ? void 0 : plugin.config.get(_1.VolsegVolumeServerConfig.DefaultServer)) !== null && _a !== void 0 ? _a : api_1.DEFAULT_VOLSEG_SERVER;
    return {
        serverUrl: param_definition_1.ParamDefinition.Text(defaultVolumeServer),
        source: param_definition_1.ParamDefinition.Mapped(SourceChoice.values[0], SourceChoice.options, function (src) { return entryParam(entrylists[src]); }),
    };
}
...
function entryParam(entries) {
    ...
    return param_definition_1.ParamDefinition.Group({
        ...
        customEntryId: param_definition_1.ParamDefinition.Text('', { hideIf: function (p) { return p.entryId !== '__custom__'; }, description: 'Entry identifier, including the source prefix, e.g. "emd-1832"' }),
    }, { isFlat: true });
}
...
})(VolsegEntryParamValues = exports.VolsegEntryParamValues || (exports.VolsegEntryParamValues = {}));
var VolsegEntry = /** @class */ (function (_super) {
    tslib_1.__extends(VolsegEntry, _super);
    function VolsegEntry() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return VolsegEntry;
}(objects_1.PluginStateObject.CreateBehavior({ name: 'Vol & Seg Entry' })));
exports.VolsegEntry = VolsegEntry;
var VolsegEntryData = /** @class */ (function (_super) {
    tslib_1.__extends(VolsegEntryData, _super);
    function VolsegEntryData(plugin, params) {
        var _this = _super.call(this, plugin, params) || this;
        _this.ref = '';
        _this.volumeData = new entry_volume_1.VolsegVolumeData(_this);
        _this.latticeSegmentationData = new entry_segmentation_1.VolsegLatticeSegmentationData(_this);
        _this.meshSegmentationData = new entry_meshes_1.VolsegMeshSegmentationData(_this);
        _this.modelData = new entry_models_1.VolsegModelData(_this);
        _this.highlightRequest = new rxjs_1.Subject();
        _this.getStateNode = (0, helpers_1.lazyGetter)(function () { return _this.plugin.state.data.selectQ(function (q) { return q.byRef(_this.ref).subtree().ofType(entry_state_1.VolsegState); })[0]; }, 'Missing VolsegState node. Must first create VolsegState for this VolsegEntry.');
        _this.currentState = new rxjs_1.BehaviorSubject(param_definition_1.ParamDefinition.getDefaultValues(entry_state_1.VolsegStateParams));
        _this.currentVolume = new rxjs_1.BehaviorSubject(undefined);
        _this.labelProvider = {
            label: function (loci) {
                ...
                if (!segment)
                    return;
                var annotLabels = segment.biological_annotation.external_references.map(function (annot) { return "".concat((0, helpers_1.applyEllipsis)(annot.label), " [").concat(annot.resource, ":").concat(annot.accession, "]"); });
        ...
        _this.plugin = plugin;
        _this.api = new api_1.VolumeApiV2(params.serverUrl);
        _this.source = params.source;
        _this.entryId = params.entryId;
        _this.entryNumber = (0, helpers_1.splitEntryId)(_this.entryId).entryNumber;
        return _this;
    }
    ...
    VolsegEntryData.prototype.register = function (ref) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                ...
                volumeVisual = this.findNodesByTags(entry_volume_1.VOLUME_VISUAL_TAG)[0];
                if (volumeVisual)
                ...
                this.subscribeObservable(this.plugin.state.data.events.cell.stateUpdated, function (e) {
                    ...
                    if (e.cell.transform.ref === _this.getStateNode().transform.ref) {
                        ...
                        if (newState && !(0, mol_util_1.shallowEqualObjects)(newState, _this.currentState.value)) { // avoid repeated update
                        ...
                        else if (mol_state_1.StateSelection.findAncestor(_this.plugin.state.data.tree, _this.plugin.state.data.cells, e.ref, function (a) { return a.transform.ref === ref; })) {
                            volumeRef = e.ref;
                            _this.currentVolume.next(e.cell.transform);
                        }
                    }
                ...
                this.subscribeObservable(this.plugin.behaviors.interaction.click, function (e) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                this.subscribeObservable(this.highlightRequest.pipe((0, rxjs_1.throttleTime)(50, undefined, { leading: true, trailing: true })), function (segment) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.highlightSegment(segment)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                }); }); });
                this.subscribeObservable(this.currentState.pipe((0, rxjs_1.distinctUntilChanged)(function (a, b) { return a.selectedSegment === b.selectedSegment; })), function (state) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    var _a;
                    return tslib_1.__generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                if (!((_a = global_state_1.VolsegGlobalStateData.getGlobalState(this.plugin)) === null || _a === void 0 ? void 0 : _a.selectionMode)) return [3 /*break*/, 2];
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, this.actionShowSegments(tslib_1.__spreadArray(tslib_1.__spreadArray([], current, true), [segment], false))];
                    case 3:
                        _a.sent();
                        _a.label = 4;
    ...
    VolsegEntryData.prototype.highlightSegment = function (segment) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, commands_1.PluginCommands.Interactivity.ClearHighlights(this.plugin)];
                    case 1:
                        _a.sent();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        newParams = tslib_1.__assign(tslib_1.__assign({}, oldParams), params);
