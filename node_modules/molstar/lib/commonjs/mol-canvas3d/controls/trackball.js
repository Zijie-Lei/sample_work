...
exports.DefaultTrackballBindings = {
    ...
    dragRotateZ: (0, binding_1.Binding)([Trigger(B.Flag.Primary, M.create({ shift: true }))], 'Rotate around z-axis', 'Drag using ${triggers}'),
    dragPan: (0, binding_1.Binding)([Trigger(B.Flag.Secondary, M.create()), Trigger(B.Flag.Primary, M.create({ control: true }))], 'Pan', 'Drag using ${triggers}'),
