        ...
        this.props = (0, immer_1.default)(this.props, function (p) {
            if (props.axes !== undefined) {
                ...
                if (props.axes.name === 'on') {
                    ...
                    var params = tslib_1.__assign(tslib_1.__assign({}, props.axes.params), { scale: props.axes.params.scale * _this.pixelRatio, labelScale: props.axes.params.labelScale * _this.pixelRatio });
...
function createAxesMesh(props, mesh) {
    ...
    var x = linear_algebra_1.Vec3.scale((0, linear_algebra_1.Vec3)(), linear_algebra_1.Vec3.unitX, scale - textScale);
    var y = linear_algebra_1.Vec3.scale((0, linear_algebra_1.Vec3)(), linear_algebra_1.Vec3.unitY, scale - textScale);
    var z = linear_algebra_1.Vec3.scale((0, linear_algebra_1.Vec3)(), linear_algebra_1.Vec3.unitZ, scale - textScale);
...
function createMeshRenderObject(props) {
    ...
    return shape_1.Shape.createRenderObject(shape, tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, param_definition_1.ParamDefinition.getDefaultValues(mesh_1.Mesh.Params)), props), { ignoreLight: true }));
}
//
...
function createTextRenderObject(props) {
    ...
    return shape_1.Shape.createRenderObject(shape, tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, param_definition_1.ParamDefinition.getDefaultValues(text_1.Text.Params)), props), { alpha: props.labelOpacity }));
}
