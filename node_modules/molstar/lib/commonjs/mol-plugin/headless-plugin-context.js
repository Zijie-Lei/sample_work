...
var HeadlessPluginContext = /** @class */ (function (_super) {
    ...
    function HeadlessPluginContext(spec, canvasSize, rendererOptions) {
        if (canvasSize === void 0) { canvasSize = { width: 640, height: 480 }; }
        var _this = _super.call(this, spec) || this;
        _this.renderer = new headless_screenshot_1.HeadlessScreenshotHelper(canvasSize, undefined, rendererOptions);
