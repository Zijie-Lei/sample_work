...
var lazy_imports_1 = require("../../mol-util/lazy-imports");
var param_definition_1 = require("../../mol-util/param-definition");
var lazyImports = lazy_imports_1.LazyImports.create('gl', 'jpeg-js', 'pngjs');
/** To render Canvas3D when running in Node.js (without DOM) */
var HeadlessScreenshotHelper = /** @class */ (function () {
    function HeadlessScreenshotHelper(canvasSize, canvas3d, options) {
        var _a, _b, _c;
        ...
        if (canvas3d) {
            ...
            var glContext = lazyImports.gl(this.canvasSize.width, this.canvasSize.height, (_a = options === null || options === void 0 ? void 0 : options.webgl) !== null && _a !== void 0 ? _a : defaultWebGLAttributes());
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        imageData = _a.sent();
                        generatedPng = new lazyImports.pngjs.PNG({ width: imageData.width, height: imageData.height });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        imageData = _a.sent();
                        generatedJpeg = lazyImports['jpeg-js'].encode(imageData, jpegQuality);
