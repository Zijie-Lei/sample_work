...
var NtCTubeSegmentsIterator = /** @class */ (function () {
    ...
    NtCTubeSegmentsIterator.prototype.toSegment = function (r0, r1, r2, r3) {
        ...
        return __assign(__assign({}, getPoints(this.loc, r0, r1, r2, altIdPrev, this.altIdOne, altIdTwo, insCodePrev, this.insCodeOne, insCodeTwo)), { stepIdx: stepIdx, followsGap: followsGap, firstInChain: !r0, capEnd: !this.residueNext || precedesDiscontinuity || hasGapElements(r2, this.loc.unit) });
    };
